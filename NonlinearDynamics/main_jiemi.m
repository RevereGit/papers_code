...
clear;clc;
I=imread('F:\Users\Revere\Desktop\NonliearDynamics\LaTeX_DL_468198_220518\fig2\encry-living','png');           %读取图像信息
imshow(I);
% I=imnoise(I,'salt & pepper',0.005);         %加入10%的椒盐噪声
I1=I(:,:,1);     %R通道
I2=I(:,:,2);     %G通道
I3=I(:,:,3);     %B通道
...
%% 保存图片
imwrite(Q_jiemi,'F:\Users\Revere\Desktop\paper\2光场加密\解密后的living.png','png');       
disp('您输入的解密密钥为：');
